...
<div class="bg-white" x-data="{ isOpen: false }">
  <header class="absolute inset-x-0 top-0 z-50">
    ...
    <div class="lg:hidden" x-show="isOpen" role="dialog" aria-modal="true" @keydown.escape.window="isOpen = false">
  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        ...
        <p class="mt-8 text-lg font-medium text-gray-500 sm:text-xl">El punto de venta mas grande en Mexicali para los juegos de cartas coleccionables.</p>
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <a href="#" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Catálogo</a>
